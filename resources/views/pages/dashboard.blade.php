          ...
          <div class="col-md-4">
            <div class="card mb-2">
              <div class="card-body">
                ...
                <div class="dashboard-card-subtitle">32</div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card mb-2">
              <div class="card-body">
                ...
                <div class="dashboard-card-subtitle">Rp. 2.302.000</div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            ...
            >
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">Boba Jaksel</div>
                  <div class="col-md-3">Lolyta</div>
            ...
            >
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">Compass</div>
                  <div class="col-md-3">Depa</div>
            ...
            >
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">Kasur Busa</div>
                  <div class="col-md-3">Fandy</div>
                  <div class="col-md-3">11 January, 2022</div>
                  <div class="col-md-1 d-none d-md-block">
                    <img
                      src="/images/dashboard-arrow-right.svg"
