          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                <h2 class="dashboard-title">{{ $transaction->first()->code }}</h2>
                <p class="dashboard-subtitle">Look what you have made with this transaction!!</p>
              </div>
              <div class="dashboard-content">
                ...
                <div class="invoice p-3 mb-3">
                  <div class="row">
                    <div class="col-12">
                      <h4>
                        <i class="fas fa-globe"></i> E-Commerce Sekolah Vokasi UNS
