                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="roles" required id="roles" class="form-control">
                                                <option value="<?php echo e($item->roles); ?>" selected>Tidak Berubah (<?php echo e($item->roles); ?>)</option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ecomsvkmm\resources\views/pages/admin/user/edit.blade.php ENDPATH**/ ?>